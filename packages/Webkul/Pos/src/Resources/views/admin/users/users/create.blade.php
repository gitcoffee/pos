...
@section('page_title')
    {{ __('pos::app.admin.users.users.add-user-title') }}
@stop

@section('content')
    <div class="content">
        <form method="POST" action="{{ route('admin.pos.users.store') }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
                ...
                <div class="form-container">
                    ...
                    <accordian :title="'{{ __('pos::app.admin.users.users.general') }}'" :active="true">
                        <div slot="body">
                            <div class="control-group" :class="[errors.has('username') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" id="username" name="username" data-vv-as="&quot;{{ __('pos::app.admin.users.users.username') }}&quot;"/>
                            ...
                            <div class="control-group" :class="[errors.has('firstname') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" id="firstname" name="firstname" data-vv-as="&quot;{{ __('pos::app.admin.users.users.firstname') }}&quot;"/>
                            ...
                            <div class="control-group" :class="[errors.has('lastname') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" id="lastname" name="lastname" data-vv-as="&quot;{{ __('pos::app.admin.users.users.lastname') }}&quot;"/>
                            ...
                            <div class="control-group" :class="[errors.has('email') ? 'has-error' : '']">
                                ...
                                <input type="email" v-validate="'required'" class="control" id="email" name="email" data-vv-as="&quot;{{ __('pos::app.admin.users.users.email') }}&quot;"/>
                    ...
                    <accordian :title="'{{ __('pos::app.admin.users.users.user-image') }}'" :active="true">
                        <div slot="body">
                            ...
                            <image-wrapper :button-label="'{{ __('pos::app.admin.users.users.add-avatar') }}'" :remove-button-label="'{{ __('pos::app.admin.users.users.remove-avatar') }}'" input-name="avatar"  :multiple="false"></image-wrapper>
                    ...
                    <accordian :title="'{{ __('pos::app.admin.users.users.password') }}'" :active="true">
                        <div slot="body">
                            <div class="control-group" :class="[errors.has('password') ? 'has-error' : '']">
                                ...
                                <input type="password" v-validate="'required|min:6|max:18'" class="control" id="password" name="password" data-vv-as="&quot;{{ __('pos::app.admin.users.users.password') }}&quot;" ref="password"/>
                            ...
                            <div class="control-group" :class="[errors.has('password_confirmation') ? 'has-error' : '']">
                                ...
                                <input type="password" v-validate="'required|min:6|max:18|confirmed:password'" class="control" id="password_confirmation" name="password_confirmation" data-vv-as="&quot;{{ __('pos::app.admin.users.users.confirm-password') }}&quot;"/>
                            ...
                            <div class="control-group" :class="[errors.has('outlet_id') ? 'has-error' : '']">
                                ...
                                <select class="control" name="outlet_id" v-validate="'required'" id="outlet" data-vv-as="&quot;{{ __('pos::app.admin.users.users.outlet') }}&quot;">
                                    ...
                                    @foreach ($outlets as $outlet)
                                        <option value="{{ $outlet->id }}" {{ (isset($outlet_id) && $outlet_id == $outlet->id) ? 'selected' : '' }}>{{ $outlet->name }}</option>
                                    @endforeach
                                </select>
